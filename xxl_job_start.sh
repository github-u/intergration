...
echo "start app ..."
cd ~/task
java -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=64m -Xms384m -Xmx384m -Xmn128m -Xss256k -XX:SurvivorRatio=8 -Xloggc:gc.log:wq  -jar xxl-job-admin-2.2.0-SNAPSHOT.jar
